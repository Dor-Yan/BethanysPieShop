...
namespace BethanysPieShopHRM.Api.Migrations
{
    ...
    [Migration("20230825103920_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BethanysPieShop.Shared.Domain.Country", b =>
                {
            ...
            modelBuilder.Entity("BethanysPieShop.Shared.Domain.Employee", b =>
                {
            ...
            modelBuilder.Entity("BethanysPieShop.Shared.Domain.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BethanysPieShop.Shared.Domain.Employee", b =>
                {
                    b.HasOne("BethanysPieShop.Shared.Domain.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BethanysPieShop.Shared.Domain.JobCategory", "JobCategory")
                        .WithMany()
